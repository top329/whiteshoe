...
function Home() {
    ...
    const connectToBackend = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.error(
            'Failed to connect to backend node app:',
            response.status
          );
        }
      } catch (error) {
  ...
  useEffect(() => {
    const fetchIpAndUsage = async () => {
      try {
        ...
        if (
          response.data &&
          response.data.usageCount !== undefined &&
          response.data.ipAddress !== undefined
        ) {
  ...
  const handleRagSubmit = async (e) => {
    ...
    try {
      ...
      console.log('short response => ', shortResponse);
          ...
          <div className="pricing-options">
            ...
            <div className="pricing-option">
              ...
              <ul>
                ...
                <li>
                  Charges $0.25 per 1000 tokens of output. That means about $1
                  per 12-16 pages of output.
                </li>
              </ul>
              <button
            ...
            <div className="pricing-option">
              ...
              <ul>
                ...
                <li>Full access, no rate limit</li>
                <li>
                  Charges $0.10 per 1000 tokens. That means about $1 per 30-40
                  pages of output.
                </li>
              </ul>
              <button
